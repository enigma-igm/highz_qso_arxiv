...
def simulate(sens, spec2DObj, sobjs, header, 
    ...
    if debug:
        ...
        # ax2.text(0.18, 0.9,'J1319+0101 (QSO, z=5.726)', ha='center', va='center', transform=ax2.transAxes, fontsize=25)
        ax2.text(0.1, 0.8,'J1326+0927 (M9)', ha='center', va='center', transform=ax2.transAxes, fontsize=20)
