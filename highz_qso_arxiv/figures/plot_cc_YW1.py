...
cov_YW1 = color_cov(mY_cand[mask_detected], mW1_cand[mask_detected], 
                    mJ_cand[mask_detected], mY_err_cand[mask_detected],
                    mW1_err_cand[mask_detected], mJ_err_cand[mask_detected])
cov_dwf_YW1 = color_cov(mY_cand[mask_dwarf], mW1_cand[mask_dwarf],
                        mJ_cand[mask_dwarf], mY_err_cand[mask_dwarf], 
                        mW1_err_cand[mask_dwarf], mJ_err_cand[mask_dwarf])
cov_unk_YW1 = color_cov(mY_cand[mask_unknown], mW1_cand[mask_unknown],
                        mJ_cand[mask_unknown], mY_err_cand[mask_unknown],
                        mW1_err_cand[mask_unknown], mJ_err_cand[mask_unknown])
cov_qso_YW1 = color_cov(mY_cand[mask_qso], mW1_cand[mask_qso],
                        mJ_cand[mask_qso], mY_err_cand[mask_qso],
...
ax, cnt_qso = plot_contour(qso_color[:,1],
                  -qso_color[:,4],
                  ax=ax, bins=50, range=((-2, 10), (-5, 8)),
                  levels=levels, 
                  smooth=.5,
                  ...
                  plot_datapoints=False,
                  color='red', zorder=1)
# ax, cnt_qso = plot_contour(qso_color[mask_z1][:,1],
#                   -qso_color[mask_z1][:,4],
#                   ax=ax, bins=50, range=((-2, 10), (-5, 8)),
#                   levels=levels, 
#                   smooth=.5,
...
# ax, cnt_qso = plot_contour(qso_color[mask_z2][:,1],
#                   -qso_color[mask_z2][:,4],
#                   ax=ax, bins=50, range=((-2, 10), (-5, 8)),
#                   levels=levels, 
#                   smooth=.5,
...
# ax, cnt_qso = plot_contour(qso_color[mask_z3][:,1],
#                   -qso_color[mask_z3][:,4],
#                   ax=ax, bins=50, range=((-2, 10), (-5, 8)),
#                   levels=levels, 
#                   smooth=.5,
...
ax, cnt_dwf = plot_contour(syn_color[:,1],
                  -syn_color[:,4],
                  ax=ax, bins=50, range=((-2, 10), (-5, 8)),
                  levels=levels, 
                  smooth=.5,
...
plot_cline(qsotrack_color[:,1], -qsotrack_color[:,4], ax=ax, cmap=plt.get_cmap('autumn_r'), linewidth=2, alpha=0.5, zorder=1)
plot_cline(dwftrack_color[:,1], -dwftrack_color[:,4], ax=ax, cmap=plt.get_cmap('winter_r'), linewidth=2, alpha=0.5, zorder=3)
ax.scatter(qsotrack_color[:,1], -qsotrack_color[:,4], s=20, marker='o', facecolor='red', edgecolor='red', zorder=2, alpha=0.6)
ax.scatter(dwftrack_color[:,1], -dwftrack_color[:,4], s=20, marker='o', facecolor=dwarf_contour_color, edgecolor=dwarf_contour_color, zorder=2, alpha=0.6)
...
ax.set_xlabel(r'$Y_{\rm AB}$ - $J_{\rm AB}$', fontsize=25)
...
if args.show:
    ...
    plt.savefig('cc_YW1.pdf', bbox_inches='tight')