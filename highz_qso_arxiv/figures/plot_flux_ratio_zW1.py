...
# ax.text(0.5, -0.9, r'$\mathbf{6<z<6.5}$ $\textbf{QSOs}$', c='lightsalmon',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0.5, -1.2, r'$\mathbf{6.5<z<7}$ $\textbf{QSOs}$', c='tomato',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0.5, -1.5, r'$\mathbf{z>7}$ $\textbf{QSOs}$', c='red',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0.5, -1.8, r'$\textbf{Brown Dwarf}$', c=dwarf_contour_color,
#                 fontsize=20, horizontalalignment='left', weight='bold')

ax.text(-0.04, -1.2, r'$\textbf{QSOs}$', c='red',
              fontsize=20, horizontalalignment='left', weight='bold', alpha=0.8)
ax.text(-0.04, -1.5, r'$\textbf{Brown Dwarf}$ ($\mathbf{m_J=21}$)', c=dwarf_contour_color,
                fontsize=20, horizontalalignment='left', weight='bold')
ax.text(-0.04, -1.8, r'$\textbf{Observed Contaminants}$', c=all_contour_color,
              fontsize=20, horizontalalignment='left', weight='bold', alpha=0.7)

ax.scatter(cand_flux[1][mask_Mdwarf] / cand_flux[0][mask_Mdwarf], cand_flux[5][mask_Mdwarf] / cand_flux[0][mask_Mdwarf], 
            s=50, marker='o', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{M dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[1][mask_Ldwarf] / cand_flux[0][mask_Ldwarf], cand_flux[5][mask_Ldwarf] / cand_flux[0][mask_Ldwarf], 
            s=50, marker='v', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{L dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[1][mask_Tdwarf] / cand_flux[0][mask_Tdwarf], cand_flux[5][mask_Tdwarf] / cand_flux[0][mask_Tdwarf], 
            s=50, marker='s', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{T dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[1][mask_qso] / cand_flux[0][mask_qso], cand_flux[5][mask_qso] / cand_flux[0][mask_qso],
            s=50, marker='o', facecolor=qso_color, edgecolor='black', label=r'$\textbf{QSO}$', zorder=5)
ax.scatter(cand_flux[1][mask_unknown] / cand_flux[0][mask_unknown], cand_flux[5][mask_unknown] / cand_flux[0][mask_unknown],
...
ax, _ = plot_contour(all_flux_ratio[:,0],
                  all_flux_ratio[:,4], 
                  ax=ax, bins=50, range=((-0.5,1.), (-2.5,8.3)),
                  levels=levels, 
                  smooth=.5,
                  lw=2,
                  alpha=0.4,
...
plot_cline(qsotrack_flux[:,0], qsotrack_flux[:,4], ax=ax, cmap=plt.get_cmap('autumn_r'), linewidth=2, alpha=0.5, zorder=1)
plot_cline(dwftrack_flux_ratio[:,0], dwftrack_flux_ratio[:,4], ax=ax, cmap=plt.get_cmap('winter_r'), linewidth=2, alpha=0.5, zorder=3)
ax.scatter(qsotrack_flux[:,0], qsotrack_flux[:,4], s=20, marker='o', facecolor='red', edgecolor='red', zorder=2, alpha=0.6)
ax.scatter(dwftrack_flux_ratio[:,0], dwftrack_flux_ratio[:,4], s=20, marker='o', facecolor=dwarf_contour_color, edgecolor=dwarf_contour_color, zorder=2, alpha=0.6)
...
ax.text(1.3, 2.8, r'${\bf z\lesssim 6.5}$', fontsize=18, color='black', zorder=5)
ax.text(0.42, 2.8, r'${\bf z\gtrsim 6.5}$', fontsize=18, color='black', zorder=5)
ax.text(-0.02, 2.8, r'${\bf z>7}$', fontsize=18, color='black', zorder=5)
...
if args.show:
    ...
    plt.savefig('flux_ratio_zW1.pdf', bbox_inches='tight')