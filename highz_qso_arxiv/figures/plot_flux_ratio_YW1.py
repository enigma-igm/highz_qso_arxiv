...
# ax.text(0., -0.9, r'$\mathbf{6<z<6.5}$ $\textbf{QSOs}$', c='lightsalmon',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0., -1.2, r'$\mathbf{6.5<z<7}$ $\textbf{QSOs}$', c='tomato',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0., -1.5, r'$\mathbf{z>7}$ $\textbf{QSOs}$', c='red',
#               fontsize=20, horizontalalignment='left', weight='bold')
# ax.text(0., -1.8, r'$\textbf{Brown Dwarf}$', c=dwarf_contour_color,
#                 fontsize=20, horizontalalignment='left', weight='bold')

ax.text(-0.9, -1.2, r'$\textbf{QSOs}$', c='red',
              fontsize=20, horizontalalignment='left', weight='bold', alpha=0.8)
ax.text(-0.9, -1.5, r'$\textbf{Brown Dwarf}$ ($\mathbf{m_J=21}$)', c=dwarf_contour_color,
                fontsize=20, horizontalalignment='left', weight='bold')
ax.text(-0.9, -1.8, r'$\textbf{Observed Contaminants}$', c=all_contour_color,
              fontsize=20, horizontalalignment='left', weight='bold', alpha=0.7)

ax.scatter(cand_flux[2][mask_Mdwarf] / cand_flux[0][mask_Mdwarf], cand_flux[5][mask_Mdwarf] / cand_flux[0][mask_Mdwarf], 
            s=50, marker='o', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{M dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[2][mask_Ldwarf] / cand_flux[0][mask_Ldwarf], cand_flux[5][mask_Ldwarf] / cand_flux[0][mask_Ldwarf], 
            s=50, marker='v', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{L dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[2][mask_Tdwarf] / cand_flux[0][mask_Tdwarf], cand_flux[5][mask_Tdwarf] / cand_flux[0][mask_Tdwarf], 
            s=50, marker='s', edgecolors='black', facecolors=dwarf_color, label=r'$\textbf{T dwarf}$', zorder=5, alpha=0.8)
ax.scatter(cand_flux[2][mask_qso] / cand_flux[0][mask_qso], cand_flux[5][mask_qso] / cand_flux[0][mask_qso],
            s=50, marker='o', facecolor=qso_color, edgecolor='black', label=r'$\textbf{QSO}$', zorder=5)
ax.scatter(cand_flux[2][mask_unknown] / cand_flux[0][mask_unknown], cand_flux[5][mask_unknown] / cand_flux[0][mask_unknown],
...
error_cov(ax, 1.3, -1.5, mean_cov, color=dwarf_color, alpha=0.7, lw=1.5)
mean_cov = np.nanmean(cov_unk_YW1, axis=0)
error_cov(ax, 1.3, -1.5, mean_cov, color=unknown_color, alpha=0.7, lw=1.5)
mean_cov = np.nanmean(cov_qso_YW1, axis=0)
error_cov(ax, 1.3, -1.5, mean_cov, color=qso_color, alpha=0.7, lw=1.5)

levels = 1.0 - np.exp(-0.5 * np.arange(0.5, 2.1, 0.5) ** 2)
ax, _ = plot_contour(all_flux_ratio[:,1],
                  all_flux_ratio[:,4], 
                  ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
                  levels=levels, 
                  smooth=.5,
                  lw=2,
                  alpha=0.4,
...
ax, cnt_qso_z1 = plot_contour(qso_flux_ratio[:,1],
                  qso_flux_ratio[:,4],
                  ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
                  levels=levels, 
                  smooth=.5,
                  ...
                  plot_datapoints=False,
                  color='red', zorder=1)
# ax, cnt_qso_z1 = plot_contour(qso_flux_ratio[mask_z1][:,1],
#                   qso_flux_ratio[mask_z1][:,4],
#                   ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
#                   levels=levels, 
#                   smooth=.5,
#                   lw=2,
...
# ax, cnt_qso_z2 = plot_contour(qso_flux_ratio[mask_z2][:,1],
#                   qso_flux_ratio[mask_z2][:,4],
#                   ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
#                   levels=levels, 
#                   smooth=.5,
#                   lw=2,
...
# ax, cnt_qso_z3 = plot_contour(qso_flux_ratio[mask_z3][:,1],
#                   qso_flux_ratio[mask_z3][:,4],
#                   ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
#                   levels=levels, 
#                   smooth=.5,
#                   lw=2,
...
ax, cnt_dwf = plot_contour(syn_flux_ratio[:,1],
                  syn_flux_ratio[:,4],
                  ax=ax, bins=50, range=((-0.7,1.4), (-2.5,8.3)),
                  levels=levels, 
                  smooth=.5,
...
plot_cline(qsotrack_flux[:,1], qsotrack_flux[:,4], ax=ax, cmap=plt.get_cmap('autumn_r'), linewidth=2, alpha=0.8, zorder=1)
plot_cline(dwftrack_flux_ratio[:,1], dwftrack_flux_ratio[:,4], ax=ax, cmap=plt.get_cmap('winter_r'), linewidth=2, alpha=0.5, zorder=3)
ax.scatter(qsotrack_flux[:,1], qsotrack_flux[:,4], s=20, marker='o', facecolor='red', edgecolor='red', zorder=2, alpha=0.6)
ax.scatter(dwftrack_flux_ratio[:,1], dwftrack_flux_ratio[:,4], s=20, marker='o', facecolor=dwarf_contour_color, edgecolor=dwarf_contour_color, zorder=2, alpha=0.6)
...
ax.set_xlabel(r'$f_{Y} / f_{J}$', fontsize=25)
ax.set_ylabel(r'$f_{W1} / f_{J}$', fontsize=25)
...
if args.show:
    ...
    # plt.savefig('flux_ratio_zW1.png', dpi=200)
    plt.savefig('flux_ratio_YW1.pdf', bbox_inches='tight')