...
fits_list = [f"../LRIS_220306/reduced/all_redo/{nm}/{nm}_coadd_tellcorr.fits" for nm in targets_0306]
fits_list[9] = "../LRIS_220306/reduced/all_redo/coadd2d/J1427+0202_coadd_tellcorr.fits"
