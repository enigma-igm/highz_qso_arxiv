...
fits_list[15] = f"../reduced/all/coadd2d/{name_list[15]}_coadd_tellcorr.fits"
idx_list = [1 for i in range(len(name_list))]
plot_series(name_list, fits_list, idx_list, telluric=True, display=False, save_file="LRIS_2201_tellcorr.pdf")
...
idx_list = [1 for i in range(len(name_list))]
plot_series(name_list, fits_list, idx_list, telluric=True, display=False, save_file="J1206_J1256.pdf")
